...
It has been just over one year since I [released version 0.8](https://twitter.com/RichardRed0x/status/1190315513043472385?s=20) of [Peer Production on the Crypto Commons (PPCC)](https://cryptocommons.cc), so this change log for the upgrade from version 0.8 to 1.0 is doubling as a recap of 2020. 
...
[^69]:*Ledger data leak: A ‘simple mistake’ exposed 270K crypto wallet buyers*. (2020). Cointelegraph. https://cointelegraph.com/news/ledger-data-leak-a-simple-mistake-exposed-270k-crypto-wallet-buyers
